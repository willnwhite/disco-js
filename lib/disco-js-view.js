...
import Ramda from './test_functions/Ramda.json';
import siblingOrCousinNodes from './test_functions/siblingsCousins.json';
...
export default class DiscoJsView {
  ...
  constructor(serializedState) {
    ...
    const submissions = [Ramda, ES6, siblingOrCousinNodes, DOM];
